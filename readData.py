...
def asdf(allstudents,l):
    l = ['calculus','geometry','pre-calculus','unknown','algebra 1', 
            'algebra 2', 'statistics', 'algebra']
    n = 0
    for e in l:
...
#
#From hear on everything is in trying to machine-learn to read course names
#
